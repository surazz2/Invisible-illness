...
import com.example.invisibleillnesses.ui.Model.AdminOrders;
import com.example.invisibleillnesses.ui.Model.AdminOrders;
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final AdminOrders model) {
                        ...
                        holder.showOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(com.example.invisibleillnesses.adminneworder.this,AdminUserProductsActivity.class);
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(com.example.invisibleillnesses.adminneworder.this);
