...
import com.example.invisibleillnesses.Prevalent.CartViewHolder;
import com.example.invisibleillnesses.Prevalent.Prevalent;
import com.example.invisibleillnesses.ui.Model.Cart;
import com.example.invisibleillnesses.ui.Shop.ShopFragment;
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        Intent intent = new Intent(CartActivity.this, ShopFragment.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });
