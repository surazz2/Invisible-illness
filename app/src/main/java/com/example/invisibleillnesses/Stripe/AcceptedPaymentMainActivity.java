...
public class AcceptedPaymentMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_accepted_payment_main);
        PaymentConfiguration.init(this, PUBLISH_KEY);
        button = findViewById(R.id.stripe_pay_button);
        ...
        imageView = findViewById(R.id.donation_image);
        Picasso.get().load("https://www.ymca.int/wp/wp-content/uploads/logo-donation.jpg").into(imageView);
        ...
        donationPrice = getIntent().getStringExtra("donation_price");
        ...
        productInfo.put("donation_price", donationPrice);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://api.stripe.com/v1/customers", new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AcceptedPaymentMainActivity.this, "Test Error", Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AcceptedPaymentMainActivity.this);
    ...
    private void onPaymentResult(PaymentSheetResult paymentSheetResult) {
        if (paymentSheetResult instanceof PaymentSheetResult.Completed) {
            progressDialog.show();
            fStore.collection("donation_order").document(id)
                    .set(productInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            progressDialog.dismiss();
                            Intent i = new Intent(AcceptedPaymentMainActivity.this, MainActivity.class);
    ...
    public void getImphericalId(String customerIdValue) {
        ...
        RequestQueue requestQueueEmp = Volley.newRequestQueue(AcceptedPaymentMainActivity.this);
